...
export const PhoneLink = () => {
  return (
    <TrackedPhoneLink
      ...
      iconAlt=""
      className="text-white items-center box-border caret-transparent gap-x-2.5 flex justify-start max-w-full gap-y-2.5 hover:text-[#c2410c] hover:decoration-transparent hover:border-[#c2410c]"
