    ...
    >
      ...
      >
        ...
        <li className="group box-border caret-transparent min-h-0 min-w-0 bg-[position:0px_0px] mx-0 w-full md:min-h-[auto] md:min-w-[auto] md:mx-0 md:w-auto md:flex md:items-center md:border-r md:border-white/20 md:pr-4 md:mr-4 md:relative">
          ...
          <ul className="box-border caret-transparent hidden md:group-hover:flex md:group-focus-within:flex md:absolute md:top-full md:left-1/2 md:-translate-x-1/2 md:w-[300px] md:items-stretch md:bg-[#1f1f1f] md:border md:border-white/10 md:rounded-xl md:p-3 md:shadow-[rgba(0,0,0,0.35)_0px_12px_30px_0px] md:mt-0 md:z-50 flex-col gap-2">
        ...
        <li className="group box-border caret-transparent min-h-0 min-w-0 bg-[position:0px_0px] mx-0 w-full md:min-h-[auto] md:min-w-[auto] md:mx-0 md:w-auto md:flex md:items-center md:border-r md:border-white/20 md:pr-4 md:mr-4 md:relative">
          ...
          <ul className="box-border caret-transparent hidden md:group-hover:flex md:group-focus-within:flex md:absolute md:top-full md:left-1/2 md:-translate-x-1/2 md:w-[240px] md:items-stretch md:bg-[#1f1f1f] md:border md:border-white/10 md:rounded-xl md:p-3 md:shadow-[rgba(0,0,0,0.35)_0px_12px_30px_0px] md:mt-0 md:z-50 flex-col gap-2">
            <li className="box-border caret-transparent w-full">
