const Stars = () => (
  <div className="flex items-center gap-0.5">
    {[...Array(5)].map((_, i) => (
      <svg key={i} className="h-4 w-4 text-[#facc15]" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div className="box-border caret-transparent flex items-center justify-center mb-[40px] md:mb-[50px]">
      ...
      >
        ...
        <div className="box-border caret-transparent">
          <div className="text-gray-100 text-base font-semibold box-border caret-transparent">Google</div>
          <div className="flex items-center gap-2 mt-0.5">
            <span className="text-white text-base font-bold">5.0</span>
            <Stars />
          </div>
          <div className="text-gray-300 text-sm box-border caret-transparent mt-1">
            Based on <span className="bg-[#1a73e8] text-white font-semibold px-2 py-0.5 rounded">11</span> Reviews
          </div>
        </div>
      </a>
    </div>
