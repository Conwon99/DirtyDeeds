...
export const categories: ServiceCategory[] = [
  {
    ...
    description: `Professional driveway, patio, decking and soft wash cleaning across ${business.region}. Weed removal, pressure washing and biocide treatments. Free quotes.`,
