...
export const categories: ServiceCategory[] = [
  {
    ...
    description: `Professional driveway, patio, decking and soft wash cleaning across ${citiesLabel()}. Weed removal, pressure washing and biocide treatments. Free quotes.`,
    ...
    localParagraph: `Properties across ${business.region} often deal with moss, algae, weeds and years of built-up grime on driveways and patios. ${brandName()} works locally with competitive prices and reliable, fully insured service.`,
    image: "/gal_01.jpg",
  ...
  },
  {
    ...
    description: `Roof cleaning, moss removal, gutter clearing and fascia cleaning across ${citiesLabel()}. Scrape and biocide method. Fully insured. Free quotes.`,
