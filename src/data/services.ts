...
export const services: ServicePage[] = [
  ...
  },
  {
    ...
    options: `${brand} cleans timber decking, composite boards and raised platforms. Light maintenance washes suit annual upkeep, while full deep cleans tackle heavy algae and ingrained dirt. Soft wash treatment can be used where a gentler approach suits the material or nearby planting. Decking cleaning can be combined with patio, path or house washing for a full exterior refresh. Jake advises on the best method for your deck type before quoting.`,
    localContext: `Decking is popular in gardens across ${region}, but damp weather and tree cover mean algae returns without periodic cleaning. Customers in Doonfoot, Prestwick and surrounding villages often book decking work alongside patio and driveway cleaning. Search for decking cleaning near me in ${region} and ${brand} provides local, fully insured service.`,
    ...
    whyChooseUs: `${brand} understands that decking needs a careful approach — not the same brute force used on concrete driveways. Customers value Jake's practical advice, tidy finishing and fair quotes. Fully insured work and free quotes across ${region} make booking simple.`,
    benefits: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. Decking, patios, driveways and house washing can often be completed in one visit. Ask Jake when requesting your quote.`,
      },
    ],
  },
  {
