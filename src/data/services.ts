...
export const services: ServicePage[] = [
  {
    ...
    description: `Professional driveway cleaning and pressure washing across ${region}. Block paving, tarmac and concrete restored. Biocide treatment available. Fully insured. Free quotes.`,
    cardDescription: `Deep driveway cleaning, pressure washing and block paving restoration across ${region}. Weed removal, re-sanding and biocide treatments to bring back colour and grip.`,
    ...
    benefits: [
      ...
      `Free quotes across ${region} and nearby towns.`,
    ],
    process: [
  ...
  },
  {
    ...
    parentCategorySlug: "exterior-cleaning-ayrshire",
    description: `Patio and path cleaning across ${region}. Pressure washing for slabs, flags and garden paths. Weed removal and biocide treatment. Fully insured. Free quotes.`,
    ...
    benefits: [
      ...
      `Reliable local service across ${region}.`,
    ],
    process: [
  ...
  },
  {
    ...
    parentCategorySlug: "exterior-cleaning-ayrshire",
    description: `Soft wash and house washing across ${region}. Exterior walls, render, UPVC, windows and doors cleaned safely. Biocide treatment. Free quotes.`,
  ...
  },
  {
    ...
    description: `Roof cleaning and moss removal across ${region}. Safe scrape method — no harsh pressure on tiles. Biocide treatment. Fully insured. Free quotes.`,
    ...
    benefits: [
      ...
      `Fully insured roof cleaning across ${region}.`,
    ],
    process: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. We provide roof cleaning and moss removal across ${region} and surrounding towns. Contact us on ${phone} for a free quote.`,
      },
      {
  ...
  },
  {
    ...
    parentCategorySlug: "roof-cleaning-ayrshire",
    description: `Gutter clearing, fascia and soffit cleaning across ${region}. Blocked gutters cleared, UPVC refreshed. Fully insured. Free quotes.`,
    ...
    benefits: [
      ...
      `Fully insured service across ${region}.`,
    ],
    process: [
  ...
  },
  {
    ...
    navTitle: "Biocide",
    parentCategorySlug: "roof-cleaning-ayrshire",
    description: `Professional biocide treatments across ${region}. Roofs, driveways, patios and walls treated to slow moss and algae regrowth. Free quotes.`,
    ...
    benefits: [
      ...
      `Available across ${region} as part of cleaning quotes.`,
    ],
    process: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. Biocide is applied across ${region} after roof cleaning, driveway washing, patio cleaning and house washing.`,
      },
      {
