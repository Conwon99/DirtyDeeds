...
export const services: ServicePage[] = [
  {
    ...
    description: `Professional driveway cleaning and pressure washing across ${cities}. Block paving, tarmac and concrete restored. Biocide treatment available. Fully insured. Free quotes.`,
    cardDescription: `Deep driveway cleaning, pressure washing and block paving restoration across ${cities}. Weed removal, re-sanding and biocide treatments to bring back colour and grip.`,
    ...
    benefits: [
      ...
      `Free quotes across ${cities} and nearby towns.`,
    ],
    process: [
  ...
  },
  {
    ...
    parentCategorySlug: "exterior-cleaning-ayrshire",
    description: `Patio and path cleaning across ${cities}. Pressure washing for slabs, flags and garden paths. Weed removal and biocide treatment. Fully insured. Free quotes.`,
    ...
    benefits: [
      ...
      `Reliable local service across ${cities}.`,
    ],
    process: [
  ...
  },
  {
    ...
    parentCategorySlug: "exterior-cleaning-ayrshire",
    description: `Soft wash and house washing across ${cities}. Exterior walls, render, UPVC, windows and doors cleaned safely. Biocide treatment. Free quotes.`,
  ...
  },
  {
    ...
    description: `Roof cleaning and moss removal across ${cities}. Safe scrape method — no harsh pressure on tiles. Biocide treatment. Fully insured. Free quotes.`,
    ...
    benefits: [
      ...
      `Fully insured roof cleaning across ${cities}.`,
    ],
    process: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. We provide roof cleaning and moss removal across ${cities} and surrounding towns. Contact us on ${phone} for a free quote.`,
      },
      {
  ...
  },
  {
    ...
    parentCategorySlug: "roof-cleaning-ayrshire",
    description: `Gutter clearing, fascia and soffit cleaning across ${cities}. Blocked gutters cleared, UPVC refreshed. Fully insured. Free quotes.`,
    ...
    benefits: [
      ...
      `Fully insured service across ${cities}.`,
    ],
    process: [
  ...
  },
  {
    ...
    navTitle: "Biocide",
    parentCategorySlug: "roof-cleaning-ayrshire",
    description: `Professional biocide treatments across ${cities}. Roofs, driveways, patios and walls treated to slow moss and algae regrowth. Free quotes.`,
    ...
    benefits: [
      ...
      `Available across ${cities} as part of cleaning quotes.`,
    ],
    process: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. Biocide is applied across ${cities} after roof cleaning, driveway washing, patio cleaning and house washing.`,
      },
      {
